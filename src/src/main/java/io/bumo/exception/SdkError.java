...
public enum SdkError {
    ...
    INVALID_ISSUE_AMMOUNT_ERROR(11008, "AssetAmount this will be issued mustbetween 1 and max(Long"),
    ...
    INVALID_ASSET_AMOUNT_ERROR(11024, "AssetMount must be between 0 and max(Long)"),
