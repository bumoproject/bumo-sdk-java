...
public enum SdkError{
    ...
    OPERATION_ERROR_NOT_DESC_ADDRESS(10001, "Target address required to be set for operation"),
    OPERATION_ERROR_STATUS(10002, "Abnormal running status"),
    ...
    TRANSACTION_ERROR_BLOB_NOT_NULL(10104, "Blob can not be empty"),
    TRANSACTION_ERROR_PUBLIC_KEY_NOT_EMPTY(10105, "The public key can not be empty"),
    TRANSACTION_ERROR_BLOB_REPEAT_GENERATOR(10106, "Do not generate Blob repeatedly"),
    ...
    TRANSACTION_ERROR_FEE_ILLEGAL(10109, "The fee value is illegal"),
    TRANSACTION_ERROR_GAS_ILLEGAL(10110, "The value of gas price is illegal"),
    ...
    RPC_INVOKE_ERROR_TIMEOUT(90004, "Accessing bottom time out!"),
