package org.bumo.sdk.core.balance;
...
import org.bumo.sdk.core.balance.model.RpcServiceContent;
import org.bumo.sdk.core.exception.ExceptionUtil;
...
import org.bumo.sdk.core.utils.http.agent.HttpServiceAgent;
import org.bumo.sdk.core.utils.http.agent.ServiceEndpoint;
...
public class RpcServiceLoadBalancer implements RpcService{
    ...
    private class RpcServiceInterceptor implements InvocationHandler{
        ...
        private String processThrowable(final Set<String> usedHosts, String useHost, Throwable t) throws Throwable{
        	org.bumo.sdk.core.utils.spring.Assert.notNull(t, "Throwable must not null!");
